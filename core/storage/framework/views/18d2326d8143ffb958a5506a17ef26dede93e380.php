                        ...
                        <div class="search-box-inner align-self-center">
                            <div class="search-box ">
                                <form class="input-group" id="header_search_form" action="<?php echo e(route('front.catalog')); ?>" method="get">
                                    ...
                                    <input class="form-control rounded-pill" type="text" data-target="<?php echo e(route('front.search.suggest')); ?>" id="__product__search" name="search" placeholder="<?php echo e(__('Search by product name')); ?>">
...
</script> Balloons By Tommy, LLC</p>
    </div>
  </footer>
...
<?php /**PATH /Applications/MAMP/htdocs/decor/core/resources/views/master/front.blade.php ENDPATH**/ ?>
            ...
            <div class="section-title-area">
                ...
                <div class="row  ltn__blog-slider-one-active slick-arrow-1">
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__blog-item">
                            <div class="ltn__blog-img">
                                <a href="blog-details.html"><img src="{{ asset('assets/images/checkthisout-video.webp') }}" alt="#"></a>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__blog-item">
                            <div class="ltn__blog-img">
                                <a href="blog-details.html"><img src="{{ asset('assets/images/checkthisout-photo.webp') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
